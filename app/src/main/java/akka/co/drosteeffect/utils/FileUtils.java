...
public class FileUtils {
	public static final String FOLDER_NAME = "drosteEffect";
	public static final String CROP_NAME = "crop";
	public static final String GIF_NAME = "gif";
	public static final String TIETU_NAME = "editphoto";
	...
	public static String getEidtFile(){
		File file = new File(FileUtils.createFolders().getAbsolutePath(), TIETU_NAME);
	...
	public static String getCropFile(){
		File file = new File(FileUtils.createFolders().getAbsolutePath(), CROP_NAME);
	...
	public static String getGifFile(){
		File file = new File(FileUtils.createFolders().getAbsolutePath(), GIF_NAME);
		if (file.isFile()){
			file.delete();
		}
		if (!file.exists()){
